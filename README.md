...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      Uptime monitoring with public status pages, multi-channel alerts (Slack/Email), and SLO tracking.
      <br/><br/>
...
> Philosophy: Zero bloat, high leverage
> Focus:      Clean UX & rapid execution
```
